...
def runtime_profile(df):
    columns = ("agent1_seconds", "agent2_seconds", "claim_retry_seconds", "comparator_seconds", "evidence_verifier_seconds", "arbiter_primary_seconds", "citation_retry_seconds", "feedback_review_seconds", "format_retry_seconds", "binary_resolution_seconds", "debate_seconds", "runtime_seconds")
    rows = []
