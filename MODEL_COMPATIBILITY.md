...
Until those checks pass, the final FigDebate architecture remains LLaVA 1.5
for observation, Mistral for claim/decision reasoning, deterministic evidence
governance, selective two-level debate, and procedural feedback memory.
